...
def procSDPAndGetMediaParams(sdp:SDP):
    ...
    print("procSDPAndGetMediaParams -> ", mediaIP)
    print("procSDPAndGetMediaParams -> ", mediaport)
    print("procSDPAndGetMediaParams -> ", mediadir)
    print("procSDPAndGetMediaParams -> ", prefaudiocodec)
    print("procSDPAndGetMediaParams -> ", srtpkey)
