...
def main():
    ...
    if isUac:
        ...
        sipCallId_map, msg_q, sigSocket, num_sessions, caller, callee, domain, isReliable, machine_call_id, media_port))
    ...
    try:
        ...
        while True:
            ...
            if buff_evt == "100":
                ...
                if callSuccess_cnt == bye_count:
                    isTrafficComplete = True
                    print("isTrafficComplete has value ", isTrafficComplete)
                    break
        ...
        logging.warning("****** %s", str(datetime.datetime.now()))
        print("****** IN Finally")
...
def startTraffic(sipCallId_map, msg_q, sigSocket, num_sessions, caller, callee, domain, isReliable, machine_callid, media_port):
    call_pumped = 0
    i = 1000
    port = media_port
