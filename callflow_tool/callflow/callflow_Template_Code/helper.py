...
def copyJsonToVM(filename, hostname):  # type can be ext, int,rw
        ...
        ssh_client.exec_command("rm -rf /root/useragent/testreport.json")
...
def executeApps(UAnodes, mapNodeIP):
        ...
        ReportingMechanismFile.startMonitoring(mapNodeIP, tid, test_desc, curr_temp_id)
...
def button(callflow, i, test_description, currtemp_id):
        global tid
        global test_desc
        global curr_temp_id
        curr_temp_id = currtemp_id
        tid = i
