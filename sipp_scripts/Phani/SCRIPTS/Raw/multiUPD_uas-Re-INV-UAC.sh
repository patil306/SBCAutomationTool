/home/sipp/sipp.svn/sipp -sf ../XML/multiUPD_uas-Re-INV-UAC.xml 10.133.48.152:5060 -i 10.133.39.159 -inf inf.csv -p 5072 -t t1  -m 1 -aa -trace_msg  -trace_err
#/root/mahi/sipp-3.4.1/sipp-3.4.1/sipp -sf ../XML/TC_NG_001_200OK_Re-TX_ACK_UAS.xml 192.168.5.110:5061 -i 192.168.5.36 -inf test420.csv -p 5061 -t l1  -m 1 -aa -trace_msg  -trace_err
