/home/sipp/sipp.svn/sipp -sf ../XML/SM_UAS.xml 192.168.6.148 -i 192.168.6.5 -inf testdemo.csv -p 5065 -t t1 -aa -trace_msg  -trace_err
...
mv ../XML/SM_UAS*messages.log ../SIPP_LOGS/
