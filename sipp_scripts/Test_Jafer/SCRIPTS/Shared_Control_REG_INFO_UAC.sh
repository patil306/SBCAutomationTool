/home/sipp/sipp.svn/sipp -sf ../XML/Shared_Control_REG_INFO_UAC.xml 192.168.6.148:5061 -i 192.168.6.5 -inf testdemo.csv -p 5065 -t l1 -m 1 -aa -trace_msg  -trace_err
