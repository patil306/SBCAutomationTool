/home/sipp/sipp.svn/sipp -sf ../XML/Trunk_Invite-External_Internal_UAC_SIPREC_Forking.xml 10.133.73.26:5060 -i 10.133.39.159 -inf testdemo.csv -p 5061 -t t1  -m 1 -aa -trace_msg  -trace_err
