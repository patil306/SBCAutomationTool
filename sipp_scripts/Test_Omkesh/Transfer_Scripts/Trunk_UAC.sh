...
#/home/sipp/sipp.svn/sipp -sf Trunk_UAC_mod1.xml 10.133.36.32 -i 10.133.39.159 -inf testdemo.csv -p 5073 -t t1 -m 1
/home/sipp/sipp.svn/sipp -sf Trunk_UAC_mod1.xml 192.168.5.143 -i 192.168.5.12 -inf testdemo.csv -p 5078 -t t1 -m 1 -aa -trace_msg  -trace_err
