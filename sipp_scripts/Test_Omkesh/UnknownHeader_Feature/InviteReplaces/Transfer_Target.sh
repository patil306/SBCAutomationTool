...
#/home/sipp/sipp.svn/sipp -sf Transfer_Target_mod8.xml 10.133.73.4 -i 10.133.39.159 -inf testdemo.csv -p 5090 -t t1
/home/sipp/sipp.svn/sipp -sf Transferer_replace4.xml 192.168.5.141 -i 192.168.5.12 -inf testdemo.csv -p 5092 -m 1 -t t1
