...
/home/sipp/sipp.svn/sipp -sf ../XML/Inbound_Basic_call_uac.xml 	192.168.5.223:5060 -i 192.168.5.12 -inf testdemo2.csv -p 5073 -t t1 -m 1 -rp 2000
...
#/home/sipp/sipp.svn/sipp -sf ../XML/Inbound_reinvite_call_uac2.xml 192.168.6.223 -i 192.168.6.5 -inf test420.csv -p 5063 -t:w t1 -m 1 -aa -trace_msg  -trace_err
