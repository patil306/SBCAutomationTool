/home/sipp/sipp.svn/sipp -sf ../XML/V-Inbound_Basic_call_uac_prackto.xml 10.133.39.197:5060 -i 10.133.39.159 -inf testdemo.csv -p 5082 -t t1 -m 1 -aa -trace_msg  -trace_err
...
mv ../XML/Inbound_407_5xx_uac*.log ../SIPP_LOGS/
