...
/home/sipp/sipp.svn/sipp -sf ../XML/Inbound_Basic_call_uac_update.xml -r 1 192.168.6.156 -i 192.168.6.5 -inf test420.csv -p 5064 -t t1 -m 1 -aa -trace_msg  -trace_err
