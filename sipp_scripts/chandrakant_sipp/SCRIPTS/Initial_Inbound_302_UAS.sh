/home/sipp/sipp.svn/sipp -sf ../XML/Initial_Inbound_302_UAS.xml 10.133.73.51 -i 10.133.39.159 -inf testdemo.csv -p 5061 -t u1 -aa -trace_msg  -trace_err
...
mv ../XML/Initial_Inbound_302_UAS.xml*messages.log ../SIPP_LOGS/
