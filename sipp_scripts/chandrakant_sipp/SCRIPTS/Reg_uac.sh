...
/home/sipp/sipp.svn/sipp -sf ../XML/Basic_Register_uac_mod.xml 10.133.73.242 -i 10.133.39.159 -inf test_reg.csv -p 5060 -t t1 -aa -trace_msg  -trace_err -m 1
...
mv ../XML/../XML/Basic_Register_uac_mod*.log ../SIPP_LOGS/
