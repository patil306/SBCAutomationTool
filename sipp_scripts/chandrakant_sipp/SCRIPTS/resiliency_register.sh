...
/home/sipp/sipp.svn/sipp -sf ../XML/resiliency_register_uas.xml 10.133.73.48 -i 10.133.39.159 -inf test420.csv -p 5062 -t t1 -m 100 -aa -trace_msg  -trace_err
...
mv ../XML/resiliency_register_uas*.log ../SIPP_LOGS/
