...
/home/sipp/sipp.svn/sipp -sf UAC_REINVITE_TLS_CONV_CONF.xml 192.168.6.146:5061 -i 192.168.6.5 -p 5061 -t l1 -r 1 -rp 2000  -m 5 -aa -trace_msg  -trace_err -inf UAS_Conv_Conf_RTP_SRTP.csv -inf finger_print.csv -t l1 
