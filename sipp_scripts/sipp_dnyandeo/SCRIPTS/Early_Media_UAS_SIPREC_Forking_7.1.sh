/home/sipp/sipp.svn/sipp -sf ../XML/Early_Media_UAS_SIPREC_Forking_7.1.xml 192.168.6.149 -i 192.168.6.5 -inf testdemo.csv -p 5065 -t t1  -aa -trace_msg  -trace_err
...
mv ../XML/Early_Media_UAS_SIPREC_Forking_7.1_*messages.log ../SIPP_LOGS/
