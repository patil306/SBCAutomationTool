/home/sipp/sipp.svn/sipp -sf ../XML/Inbound_488_uac.xml 10.133.73.51:5060 -i 10.133.39.159 -inf testdemo.csv -p 5061 -t t1 -m 1 -aa -trace_msg  -trace_err
...
mv ../XML/Inbound_488_uac*.log ../SIPP_LOGS/
