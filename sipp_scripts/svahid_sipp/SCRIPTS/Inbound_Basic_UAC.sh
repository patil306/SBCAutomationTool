...
#/home/sipp/sipp.svn/sipp -sf ../XML/Inbound_Basic_call_uac_video.xml 192.168.6.223:5060 -i 192.168.6.5 -inf testdemo2.csv -p 5063 -t t1 -m 1 -rp 2000 -aa -trace_msg  -trace_err
