/home/sipp/sipp.svn/sipp -sf ../XML/Inbound_488_uas.xml 10.133.73.51 -i 10.133.39.159 -inf testdemo.csv -p 5061 -t t1 -m 1 -aa -trace_msg  -trace_err
...
mv ../XML/Outbound_488_uas*.log ../SIPP_LOGS/
