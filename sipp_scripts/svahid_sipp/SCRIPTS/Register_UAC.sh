/home/sipp/sipp.svn/sipp -sf ../XML/Shared_Control_REG_INFO_UAC.xml 10.133.73.54:5061 -i 10.133.39.159 -inf num_time.csv -p 5061 -t l1 -m 1  -aa -trace_msg  -trace_err
...
mv ../XML/Shared_Control_REG_INFO_UAC*.log ../SIPP_LOGS/
