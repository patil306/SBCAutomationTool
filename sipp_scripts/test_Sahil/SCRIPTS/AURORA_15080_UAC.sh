...
/home/sipp/sipp.svn/sipp -sf ../XML/Basic_call_AURORA_15080_uac.xml 10.133.48.83:5060 -i 10.133.39.159 -inf test420.csv -p 5094 -aa -trace_msg  -trace_err -t t1 -m 1
