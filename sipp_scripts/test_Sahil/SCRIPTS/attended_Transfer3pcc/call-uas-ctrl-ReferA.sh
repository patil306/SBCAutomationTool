...
/home/sipp/sipp.svn/sipp -i 10.133.39.159 -p 5092 -3pcc 127.0.0.1:4000 -sf ../../XML/attended_Transfer3pcc/call-uas-ctrl-ReferALeg.xml -inf ../test420.csv -t t1 -m 1 -nd -trace_msg -trace_err -trace_logs 10.133.48.83:5060
