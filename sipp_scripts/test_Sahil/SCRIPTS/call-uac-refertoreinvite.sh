...
/home/sipp/sipp.svn/sipp -sf ../XML/attended_Transfer3pcc/call-uac-refertoreinvite.xml 192.168.55.78:5060 -i 192.168.5.12 -inf testdemo.csv -p 5092 -t t1  -m 1 -aa -trace_msg  -trace_err -trace_logs
