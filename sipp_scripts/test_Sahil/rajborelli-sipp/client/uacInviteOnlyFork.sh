...
/home/sipp/sipp.svn/sipp -sf InviteOnlyFork.xml 10.133.48.218:5060 -i 10.133.39.159 -inf NordStromPriValue-New.csv -p 6021 -t u1 -m 1 -aa -trace_msg  -trace_err -r 1
