...
/home/sipp/sipp.svn/sipp -sf NordStromPriRegSubNot.xml 192.168.25.216:5060 -i 192.168.5.12 -inf NordStromPriValue-new.csv -p 6025 -t u1  -aa -trace_msg  -trace_err
