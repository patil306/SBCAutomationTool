...
/home/sipp/sipp.svn/sipp -sf InviteSimpleNoAuth.xml 192.168.56.101:5060 -i 192.168.56.202 -inf NordStromPriValue-new.csv -p 6025 -t u1  -aa -trace_msg  -trace_err
