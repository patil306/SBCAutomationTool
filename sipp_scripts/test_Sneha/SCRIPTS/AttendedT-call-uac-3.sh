...
/home/sipp/sipp.svn/sipp -sf ../XML/attended_Transfer3pcc/Call_user3.xml -3pcc 127.0.0.1:4000  192.168.55.78:5060 -i 192.168.5.12 -inf testdemo.csv -p 5094 -t t1  -m 200 -aa -trace_msg  -trace_err -trace_logs   
