...
/home/sipp/sipp.svn/sipp -sf ../XML/attended_Transfer3pcc/Call_user4.xml  10.133.48.83:5060 -i 10.133.39.159 -inf testdemo.csv -p 5094 -t t1  -m 200 -m 1 -aa -trace_msg  -trace_err 
