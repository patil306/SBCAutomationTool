...
/home/sipp/sipp.svn/sipp -sf ../XML/uac_XeroxCore_replaces_ReplaceUAC.xml 10.133.48.163:5060 -i 10.133.39.159 -inf test40006.csv -p 5092 -t t1  -aa -trace_msg  -trace_err -m 1
