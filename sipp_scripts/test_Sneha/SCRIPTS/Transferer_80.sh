...
/home/sipp/sipp.svn/sipp -sf ../XML/Transferer_15509_80.xml 192.168.55.78:5060 -i 192.168.5.12 -inf testdemo.csv -p 5092 -t t1 -aa -trace_msg  -trace_err -r 5
...
mv ../XML/Transferer*.log ../SIPP_LOGS/
