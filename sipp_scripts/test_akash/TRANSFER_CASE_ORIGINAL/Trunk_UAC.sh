...
#/home/sipp/sipp.svn/sipp -sf TransfereeBlindTransfer_SendHold.xml 192.168.55.74:5060 -i 192.168.5.12 -inf testdemo.csv -p 5096 -t t1 -aa -trace_msg  -trace_err -m 1
