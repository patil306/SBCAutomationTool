/home/sipp/sipp.svn/sipp -sf ../XML/AURORA-11996_UAC.xml 10.133.48.235:5060 -i 10.133.39.159 -inf test420.csv -p 5075 -t t1  -aa -trace_msg  -trace_err -m 1
...
mv ../XML/AURORA-11996_UAC*.log ../SIPP_LOGS/
