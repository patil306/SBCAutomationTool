/home/sipp/sipp.svn/sipp -sf ../XML/AURORA_12841_UAS.xml 10.133.48.149:5060 -i 10.133.39.159 -inf test420.csv -p 5075  -aa -trace_msg  -trace_err -m 1
...
mv ../XML/AURORA_12841_UAC*.log ../SIPP_LOGS/
