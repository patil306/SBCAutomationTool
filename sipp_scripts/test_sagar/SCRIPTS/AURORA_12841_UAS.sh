/home/sipp/sipp.svn/sipp -sf ../XML/AURORA_12841_UAC.xml 192.168.6.242 -i 192.168.6.5 -inf test420.csv -p 5075 -t t1 -m 1 -aa -trace_msg  -trace_err
...
mv ../XML/AURORA_12841_UAS*.log ../SIPP_LOGS/
