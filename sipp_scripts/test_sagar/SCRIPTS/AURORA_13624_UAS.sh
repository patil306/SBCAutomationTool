/home/sipp/sipp.svn/sipp -sf ../XML/AURORA-13624_uas.xml 192.168.55.80:5060 -i 192.168.5.12 -inf testdemo.csv -p 5075 -t t1  -m 1 -aa -trace_msg  -trace_err -m 1
...
mv ../XML/AURORA-13624_uas*.log ../SIPP_LOGS/
