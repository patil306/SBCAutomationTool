/home/sipp/sipp.svn/sipp -sf ../XML/AURORA_14249_UAS2_backup_17_08_2018.xml 192.168.6.243 -i 192.168.6.5 -inf test420.csv -p 5075 -t t1  -m 1 -aa -trace_msg  -trace_err
