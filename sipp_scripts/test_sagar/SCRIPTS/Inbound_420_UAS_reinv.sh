/home/sipp/sipp.svn/sipp -sf ../XML/Inbound_420_uas_reinv.xml 192.168.6.221 -i 192.168.6.5 -inf test420.csv -p 5060 -t t1 -aa -trace_msg  -trace_err
...
mv ../XML/Inbound_420_uas*.log ../SIPP_LOGS/
