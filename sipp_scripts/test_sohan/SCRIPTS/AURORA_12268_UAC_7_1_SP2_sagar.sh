/home/sipp/sipp.svn/sipp -sf ../XML/AURORA_12268_UAC_SUBSCRIBE_METHOD.xml 10.133.48.157:5060 -i 10.133.39.159 -inf test420.csv -p 5075 -t t2  -aa -trace_msg  -trace_err -m 1
