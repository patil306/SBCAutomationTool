/home/sipp/sipp.svn/sipp -sf ../XML/Inbound_SIPS_uas.xml 192.168.6.148 -i 192.168.6.5 -inf testdemo.csv -p 5065 -t t1 -aa -trace_msg  -trace_err
...
mv ../XML/Inbound_SIPS_uas*.log ../SIPP_LOGS/
