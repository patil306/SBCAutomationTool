/home/sipp/sipp.svn/sipp -sf ../XML/AURORA-11996_UAS.xml 192.168.6.240 -i 192.168.6.5 -inf test420.csv -p 5075 -t t1  -m 1 -aa -trace_msg  -trace_err
...
mv ../XML/AURORA-11996_UAS*.log ../SIPP_LOGS/
