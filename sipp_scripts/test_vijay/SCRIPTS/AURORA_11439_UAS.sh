/home/sipp/sipp.svn/sipp -sf ../XML/AURORA_11439_UAS.xml 192.168.6.240 -i 192.168.6.5 -inf test420.csv -p 5076 -t l1  -m 1 -aa -trace_msg  -trace_err
...
mv ../XML/AURORA_11439_UAS*.log ../SIPP_LOGS/
