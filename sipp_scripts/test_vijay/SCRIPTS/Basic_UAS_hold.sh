/home/sipp/sipp.svn/sipp -sf ../XML/Basic_callwithhold_uas.xml 192.168.6.242 -i 192.168.6.5 -inf test420.csv -p 5076 -t l1  -m 1 -aa -trace_msg  -trace_err
#/home/sipp/sipp.svn/sipp -sf ../XML/Basic_callwithhold_uas.xml 192.168.55.71 -i 192.168.5.12 -inf test420.csv -p 5075 -t t1  -m 1 -aa -trace_msg  -trace_err
...
mv ../XML/Basic_callwithhold_uas*.log ../SIPP_LOGS/
