/home/sipp/sipp.svn/sipp -sf ../XML/Trunk_Invite-External_Internal_UAC_SIPREC_7.1.xml 10.133.73.53:5060 -i 10.133.39.159 -inf testdemo.csv -p 5061 -t t1  -m 1 -aa -trace_msg  -trace_err
...
mv Trunk_Invite-External_Internal_UAC_SIPREC_7*.log ../SIPP_LOGS/
